...
class TestWopStandard:
    ...
    appId='3uuvdg7n'
    appSecret = 'mee6tvfgtnw18s1v9fdx05vw'
    ...
    openIds = ['osAL-tngXyg0ozRIvoq9c2PFOK5s','oa1P4szB7aYNhoh5et28zYJz_yeg']
    ...
    #     data = {
    #         "queryType":2,
    #         "queryValue":self.memberIds.get("normal_mobile")
    #     }
    #     params["data"] = str(data)
    #     sign = wopV4Lib.right_sign(params,self.appSecret)
    #     params["sign"] = sign
    ...
    def test_getFansInfo(self):
        ...
        payload = copy.copy(self.comParams)
        payload["timestamp"] = get_now_time()
        headers = {'content-type': 'application/x-www-form-urlencoded'}
        # for op in self.openIds:
        data = {
            "openId":"osAL-tngXyg0ozRIvoq9c2PFOK5s"
        }
        payload["data"] = str(data)
        sign = wopV4Lib.right_sign(payload,self.appSecret)
        payload["sign"] = sign
        # print(params)
...
if __name__ == '__main__':
    ...
    pytest.main("-v test_wopStandardAlldragon.py --html=report/sampleReport.html")